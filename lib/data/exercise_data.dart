...
class ExerciseData {
  ...
  static const Map<String, String?> _exerciseImageMap = {
    ...
    'incline_barbell_bench_press': 'Barbell_Incline_Bench_Press_-_Medium_Grip',
    ...
    'lateral_raises': 'Cable_Seated_Lateral_Raise',
    'front_raises': 'Front_Dumbbell_Raise',
    'rear_delt_flyes': 'Cable_Rear_Delt_Fly',
    'upright_row': 'Dumbbell_One-Arm_Upright_Row',
    'shrugs': 'Dumbbell_Shrug',
    'cable_lateral_raises': 'Cable_Seated_Lateral_Raise',
    ...
    'skull_crushers': 'EZ-Bar_Skullcrusher',
    'close_grip_bench_press': 'Close-Grip_Barbell_Bench_Press',
    'tricep_dips': 'Dips_-_Triceps_Version',
    'overhead_tricep_extension': 'Cable_Rope_Overhead_Triceps_Extension',
    'wrist_curl': 'Cable_Wrist_Curl',
    // 腿部
    'barbell_squat': 'Barbell_Squat',
    'front_squat': 'Front_Barbell_Squat',
    'leg_press': 'Leg_Press',
    'leg_extension': 'Leg_Extensions',
    'romanian_deadlift': null, // 没有找到匹配，可用 Barbell_Deadlift 替代
    'leg_curl': 'Lying_Leg_Curls',
    'lunges': 'Dumbbell_Lunges',
    'bulgarian_split_squat': null, // 没有找到匹配，可用 Barbell_Side_Split_Squat 替代
    'calf_raises': 'Barbell_Seated_Calf_Raise',
